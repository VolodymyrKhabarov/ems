...
class EmsTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.dev = system.SalariedEmployee('Andriy', 'Maksymonko', 'dev')
        ...
        self.company_2 = system.Company('Cex.io', 1000, [self.dev, self.he_ceo])
    ...
    def test_get_ceos(self):
        ...
        self.assertEqual([self.he_ceo], self.company_2.get_ceos())
    ...
    def test_get_developers(self):
        ...
        self.assertEqual([self.dev], self.company_2.get_developers())
